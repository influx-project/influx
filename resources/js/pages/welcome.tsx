...
export default function Welcome() {
    ...
    return (
        <>
            <Head title="Welcome" />
            <div className="flex min-h-screen flex-col items-center p-6 text-foreground lg:justify-center lg:p-8">
                <header className="mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl">
                    <nav className="flex items-center justify-end gap-4">
                        {auth.user ? (
                            <Link
                                href={dashboard()}
                                className="inline-block glass-lift rounded-lg glass px-5 py-1.5 text-sm leading-normal"
                            >
                                Dashboard
                            </Link>
                        ) : (
                            <>
                                <Link
                                    href={login()}
                                    className="inline-block rounded-lg border border-transparent px-5 py-1.5 text-sm leading-normal transition-colors duration-200 hover:bg-accent"
                                >
                                    Log in
                                </Link>
                                <Link
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg glass p-6 pb-12 text-[13px] leading-[20px] motion-safe:animate-rise lg:rounded-tl-lg lg:rounded-br-none lg:p-20">
                            ...
                            <ul className="flex gap-3 text-sm leading-normal">
                                <li>
                                    <a
                                        ...
                                        target="_blank"
                                        className="inline-block rounded-lg bg-linear-to-br from-primary to-primary-glow px-5 py-1.5 text-sm leading-normal text-primary-foreground shadow-md shadow-primary/30 transition-all duration-200 hover:-translate-y-px hover:shadow-lg hover:brightness-110"
                                    >
                                        Deploy now
                                    </a>
                                </li>
